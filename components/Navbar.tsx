...
export default function Navbar() {
  ...
  useEffect(() => {
    // O Firebase "escuta" em tempo real se o utilizador está logado ou não
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            {/* Botão de Anunciar (Sempre visível, mas exige login para funcionar) */}
            <Link 
            ...
            >
              ...
              <span className="hidden sm:inline">Anunciar agora</span>
            </Link>
