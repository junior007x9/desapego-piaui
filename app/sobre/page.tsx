...
import { Target, Users, ShieldCheck, Zap, Heart, MapPin, CheckCircle2, MessageCircle } from 'lucide-react'
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20 font-sans">
      ...
      <div className="bg-primary pt-16 pb-24 px-4 rounded-b-[3rem] md:rounded-b-[4rem] shadow-lg relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-primary-100 font-medium text-lg max-w-2xl mx-auto">
            Conectando quem quer vender com quem quer comprar em todo o estado do Piauí, de forma rápida e sem burocracia.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-10 relative z-20">
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center">
            <div className="flex-1">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed font-medium">
                ...
                <p>
                  Somos uma plataforma de classificados (vitrine virtual) projetada para facilitar a vida de quem tem algo para desapegar e de quem busca oportunidades 
                  com o melhor custo-benefício em Teresina, Parnaíba, Picos, Floriano e em todos os municípios do Piauí. Sem taxas e sem comissões ocultas.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/3 bg-green-50 p-8 rounded-3xl border border-green-100 flex flex-col items-center text-center shadow-sm">
               ...
               <p className="text-sm text-gray-600 font-medium">Sem chats travando. O comprador clica e fala direto com você no seu número.</p>
            </div>
          </div>
        </div>
        ...
        {/* COMO FUNCIONA */}
        <div className="bg-gradient-to-br from-primary to-primary-dark text-white p-10 md:p-16 rounded-[3rem] shadow-xl relative overflow-hidden mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            <div className="text-center group">
              <div className="w-20 h-20 bg-white/10 text-accent rounded-2xl flex items-center justify-center text-3xl font-black mx-auto mb-6 backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform">1</div>
              <h4 className="font-black text-xl mb-3">Anuncie Grátis</h4>
              <p className="text-primary-100 text-sm font-medium leading-relaxed">Tire fotos boas, coloque um preço justo e adicione seu WhatsApp. É rápido e sem burocracia.</p>
            </div>
            <div className="text-center group">
              <div className="w-20 h-20 bg-white/10 text-accent rounded-2xl flex items-center justify-center text-3xl font-black mx-auto mb-6 backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform">2</div>
              <h4 className="font-black text-xl mb-3">Fale no WhatsApp</h4>
              <p className="text-primary-100 text-sm font-medium leading-relaxed">Os interessados verão o seu anúncio e enviarão uma mensagem diretamente para o seu celular.</p>
            </div>
            <div className="text-center group">
              <div className="w-20 h-20 bg-white/10 text-accent rounded-2xl flex items-center justify-center text-3xl font-black mx-auto mb-6 backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform">3</div>
              <h4 className="font-black text-xl mb-3">Feche Negócio</h4>
              <p className="text-primary-100 text-sm font-medium leading-relaxed">Combine de encontrar a pessoa em um local público e seguro. Receba o PIX e entregue o produto!</p>
            </div>
          </div>
        </div>
